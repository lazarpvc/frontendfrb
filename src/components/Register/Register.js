...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://face-recognition-brain-back-end.onrender.com/register', {
            method: 'post',
                    ...
                    <div className="measure">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mv3">
                                ...
                                <input className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="email" id="email" onChange={this.onEmailChange} />
                            </div>
                            <div className="mv3">
